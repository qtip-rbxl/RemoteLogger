...
titleLabel.Text = "Remote Logger v1 BETA by Q-Tip"
...
local function logRemoteCall(remoteName, callType, args)
    ...
    logButton.MouseButton1Click:Connect(function()
        ...
        logDetailsTextBox.Text = "Remote: " .. remoteName .. "\nType: " .. callType .. "\nArguments:\n" .. argsText
    end)
end
...
local function logRemoteEvent(remote)
    remote.OnClientEvent:Connect(function(...)
        local args = {...}
        logRemoteCall(remote:GetFullName(), "RemoteEvent", args)
    end)
end
...
print("RemoteLogger loaded. Wrote by Q-Tip [@love_every0ne]")
